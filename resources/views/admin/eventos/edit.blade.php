...
@section('title', 'Editar Evento - Panel Admin')
...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Actualiza los datos del evento</p>
        </div>
            ...
            <form action="{{ route('admin.eventos.update', $evento) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="url" 
                           name="enlace_externo" 
                           id="enlace_externo" 
                           value="{{ old('enlace_externo', $evento->enlace_externo) }}"
                ...
                <div class="mb-6">
                    <label for="imagen" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $evento->imagen_url ? 'Cambiar Imagen' : 'Imagen del Evento' }} 
                        @if(!$evento->imagen_url)<span class="text-red-500">*</span>@endif
                    </label>
                    <input type="file" 
                           name="imagen" 
                           id="imagen" 
                ...
                <div class="mb-6">
                    ...
                    <select name="activo" 
                        ...
                        <option value="1" {{ old('activo', $evento->activo) == 1 ? 'selected' : '' }}>Activo (visible en el carrusel)</option>
                        <option value="0" {{ old('activo', $evento->activo) == 0 ? 'selected' : '' }}>Inactivo (oculto)</option>
                    </select>
                </div>
