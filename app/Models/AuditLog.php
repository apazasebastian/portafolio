...
class AuditLog extends Model
{
     ...
     */
    public function scopeOfAction(\Illuminate\Database\Eloquent\Builder $query, string $action): void
    {
     ...
     */
    public function scopeBetweenDates(\Illuminate\Database\Eloquent\Builder $query, string $from, string $to): void
    {
     ...
     */
    protected function actionName(): \Illuminate\Database\Eloquent\Casts\Attribute
    {
        return \Illuminate\Database\Eloquent\Casts\Attribute::make(
            get: fn () => match($this->action) {
                // Reservas
