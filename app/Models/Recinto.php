...
class Recinto extends Model
{
    ...
    /**
     *  ACTUALIZADO: Verifica disponibilidad con fechas específicas 
     */
    public function disponibleEn($fecha, $horaInicio, $horaFin)
    {
        ...
        //  VERIFICAR DÍAS COMPLETOS CERRADOS 
        $diasCompletos = [];
        ...
        //  VERIFICAR BLOQUEOS POR FECHA ESPECÍFICA 
    ...
    /**
     *  ACTUALIZADO: Obtener bloqueos para una fecha específica 
     */
